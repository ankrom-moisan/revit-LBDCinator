...
namespace LBDCinator
{
    class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            RibbonPanel newPanel = a.CreateRibbonPanel(tabName, "LBDCinator");
            string thisAssemblyPath = Assembly.GetExecutingAssembly().Location;

            PushButtonData button1Data = new PushButtonData("command",
                "Replace", thisAssemblyPath, "LBDCinator.Command");
            PushButton pushButton1 = newPanel.AddItem(button1Data) as PushButton;
            pushButton1.LargeImage = BmpImageSource(@"LBDCinator.Embedded_Media.large.png");

            /////////////////////   ADD STACKED BUTTONS   ////////////////////////////////////////////
            //PushButtonData tagSData = new PushButtonData("sButton1",
            //    "Button1", thisAssemblyPath, "LBDCinator.class");
            //PushButtonData tagLData = new PushButtonData("sButton2",
            //    "Button2", thisAssemblyPath, "LBDCinator.class");
            ...
            //    tagS.Image = BmpImageSource(@"LBDCinator.Embedded_Media.small.png");
            //    PushButton tagL = stackedItems[1] as PushButton;
            //    tagL.Image = BmpImageSource(@"LBDCinator.Embedded_Media.small.png");
            //}
            ///////////////////////////////////////////////////////////////////////////////////////////
